            ...
            {location.state.quizDetails.map((score, index) => (
              <li key={index}>
                <div>
                  ...
                  {score.userAnswer === score.correctAnswer ?
                    <span className="correct result-answer">{score.userAnswer}</span> :
                    <>
                      <span className="false result-answer">{score.userAnswer}</span>
                      <div className="result-answer">Bonne réponse : {score.correctAnswer}</div>
                    </>
                  }
                </div>
              </li>
